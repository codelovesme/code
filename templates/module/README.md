...
- The first-party modules —
  [`terminal`, `math`, `strings`, `net`](https://github.com/codelovesme/code/tree/main/crates/modules)
  — are the worked examples. `net` is the one to read for a module that does
