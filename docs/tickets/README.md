...
| [T9](T9-ast-spans-for-runtime-diagnostics.md) | Carry AST spans for located runtime errors (interpreter/single-file done; codegen + multi-file deferred) | Medium | partial |
